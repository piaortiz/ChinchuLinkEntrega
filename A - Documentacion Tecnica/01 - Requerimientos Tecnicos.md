# REQUERIMIENTOS TECNICOS - ChinchuLink 

## **INFORMACIÓN DEL DOCUMENTO**

| **Campo** | **Descripción** |
|-----------|-----------|
| **Documento** | Requerimientos Tecnicos - Sistema ChinchuLink |
...
| **Última Revisión** | Análisis completo de funcionalidad implementada |
...
- **SQL Server Express** (Solo pruebas locales - limitaciones aplicables)
...
### **2.3 Especificaciones Óptimas (Alta Carga)**

| **Componente** | **Especificación Óptima** | **Beneficios** |
|----------------|---------------------------|----------------|
| **CPU** | 16 cores x 3.0 GHz | Máximo paralelismo |
| **RAM** | 128 GB | Buffer completo en memoria |
| **Almacenamiento** | 2 TB NVMe RAID 10 | Máxima velocidad I/O |
| **Red** | 10 Gbps | Sin cuello de botella |
| **Backup Storage** | 5 TB | Retención extendida |
...
| **Firewall** | Permitir puerto 1433 | Configurar en Windows |
...
- **Empleado**: Crear y gestionar pedidos
- **Cajero**: Procesar pagos y cerrar pedidos  
- **Reportes**: Solo consultas y reportes
- **Cliente**: Consultar menú y disponibilidad
...
|-------------|---------------------|-------------------|---------------------|
| **Express** | Gratis | Desarrollo/Pequeñas apps | $0 |
